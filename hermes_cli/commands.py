...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("ideas", "Scan codebase and generate improvement ideas", "Session",
               cli_only=True, aliases=("improve",), args_hint="[project] [--local] [--file <path>]"),
    ...
    CommandDef("auto", "Start/stop the autonomous action loop", "Session",
               aliases=("autono",), args_hint="[start|stop|status]",
